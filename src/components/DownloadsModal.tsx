...
import { Download, FileText, Gift, X } from 'lucide-react';
        ...
        >
          ...
          <div className="flex-shrink-0 bg-[#3a2215] text-[#fdfaf2] p-6 relative flex flex-col items-center text-center">
             ...
             <p className="font-body text-[#d6c7af] mt-2 relative z-10 max-w-lg">
                Aquí tienes acceso directo a todos tus manuales principales y los 6 bonos especiales. Descarga los PDFs para leerlos cuando quieras.
             </p>
          </div>
