          ...
          <div className="flex-1 w-full overflow-y-auto relative">
             ...
             <div className="relative z-10 flex flex-col w-full min-h-full">
                ...
                <div className="w-full h-[30vh] sm:h-[40vh] md:h-[50vh] bg-[#f4ead0] border-b-4 border-[#8a3c1f] shrink-0">
                  <img 
                    src={(!recipe.imageUrl || recipe.imageUrl.includes('picsum.photos') || recipe.imageUrl.includes('unsplash.com')) ? `https://raw.githubusercontent.com/rafa100x/remedios/main/public/recetas/botica-receta-${recipe.id.toString().padStart(3, '0')}.jpg` : recipe.imageUrl} 
