...
export default function App() {
  ...
  const searchResults = useMemo(() => {
    ...
    const synonyms: Record<string, string[]> = {
      'higado': ['hepatico', 'bilis', 'boldo', 'cardo', 'alcachofa', 'depurativo', 'hepatica', 'funcion'],
      'colon': ['intestino', 'digestion', 'inflamacion', 'estreñimiento', 'gases', 'espasmos', 'flatulencias'],
      'gastritis': ['estomago', 'ardor', 'digestivo', 'mucosa', 'ulcer', 'reflujo', 'acidez', 'pesadez'],
      'acidez': ['estomago', 'ardor', 'digestivo', 'reflujo', 'gastritis', 'pesadez'],
      'estomacal': ['estomago', 'ardor', 'digestivo', 'reflujo', 'gastritis', 'pesadez'],
      'diente': ['bucal', 'encias', 'clavo', 'dolor', 'infeccion', 'analgesico'],
      'boca': ['bucal', 'encias', 'llagas', 'enjuague', 'infeccion'],
      'muela': ['diente', 'bucal', 'clavo', 'dolor', 'analgesico', 'infeccion'],
      'desinflamar': ['inflamacion', 'antiinflamatorio', 'hinchazon', 'articular', 'dolor'],
      'asma': ['respiratorio', 'pulmones', 'tos', 'bronquios', 'expectorante', 'eucalipto', 'mucosidad', 'vias'],
      'rodilla': ['articulaciones', 'muscular', 'artrosis', 'artritis', 'reumatismo', 'huesos', 'articular'],
      'grasa': ['colesterol', 'metabolismo', 'adelgazar', 'peso', 'trigliceridos', 'lipidos', 'digestion', 'hepatica'],
      'sex': ['energia', 'vigor', 'libido', 'afrodisiaco', 'hormonal', 'vitalidad', 'maca', 'cansancio'],
      'potenciador': ['energia', 'vigor', 'libido', 'afrodisiaco', 'hormonal', 'vitalidad', 'sexual'],
      'sexual': ['energia', 'vigor', 'libido', 'afrodisiaco', 'hormonal', 'vitalidad', 'sex', 'potenciador'],
      'precoz': ['energia', 'vigor', 'libido', 'afrodisiaco', 'vitalidad', 'ansiedad', 'nervios', 'relajante'],
      'contractura': ['muscular', 'musculo', 'tension', 'relajante', 'calambre', 'dolores'],
      'menopausia': ['hormonas', 'sofocos', 'fitoestrogenos', 'menstrual', 'salvia', 'calores'],
      'uremia': ['riñones', 'diuretico', 'gota', 'depurativo', 'orina', 'urico', 'liquidos', 'renal'],
      'urico': ['riñones', 'diuretico', 'gota', 'depurativo', 'orina', 'uremia', 'liquidos', 'renal'],
      'acido urico': ['riñones', 'diuretico', 'gota', 'depurativo', 'orina', 'uremia', 'liquidos', 'renal'],
      'acido': ['urico', 'estomago'],
    };
